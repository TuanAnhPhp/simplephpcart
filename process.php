...
if (isset($_POST) && !empty($_POST)){
    /**
     * Check xem $_POST cos tồn tại hay không,tức là có dữ liệu được gửi đi
            ...
            case 'add' :
                if (isset($_POST['quantity']) && isset($_POST['product_id'])){
                    ...
                    if (isset($_SESSION['cart_item']) && !empty($_SESSION['cart_item'])){
                        /**
                         * !empty($_SESSION['cart_item']) == TRUE,tức là lúc này giỏ hàng có dữ liệu
                         */
                        ...
                        /**
                         * !empty($_SESSION['cart_item']) == FALSE,tức là lúc này giỏ hàng không có dữ liệu
                         */
