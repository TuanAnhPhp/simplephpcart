...
<div class="container">
    ...
    <?php }else{ ?>
        <div class="container">
            <h2>Giỏ hàng</h2>
            <p style="color: red;font-style: italic;text-align: center">~Giỏ hàng của bạn đang rỗng~</p>
        </div>
    <?php }?>
    ...
    <p style="font-family: Arial;font-weight: bold">
        &copy; Copyrights 2019. Designed By <span><a href="#">LPHP 1809E
                <i class="fa fa-facebook" aria-hidden="true" style="padding-left: 800px"></i></a></span>
        <span><a href="#"><i class="fa fa-twitter" aria-hidden="true" style="margin-left: 10px"></i></a></span>
        <span><a href="#"><i class="fa fa-instagram" aria-hidden="true" style="margin-left: 10px"></i></a></span>
    </p>
